...
public:
	D3D12ShaderResourceBuffer(const D3D12_SHADER_RESOURCE_VIEW_DESC&);
...
public:
	D3D12RenderTargetBuffer(const D3D12_RENDER_TARGET_VIEW_DESC&);
...
public:
	D3D12DepthStencilBuffer(const D3D12_DEPTH_STENCIL_VIEW_DESC&);
...
public:
	D3D12UnorderedAccessBuffer(const D3D12_UNORDERED_ACCESS_VIEW_DESC&);
