...
int Win32Application::Run(MiniEngine* pEngine, HINSTANCE hInstance, int nCmdShow)
{
...
{
    MiniEngine* pEngine = reinterpret_cast<MiniEngine*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
